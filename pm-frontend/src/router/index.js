...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'my-tasks', name: 'MyTasks', component: () => import('../views/MyTasks.vue'), meta: { title: '我的待填报', roles: ['engineer'] } },
      { path: 'my-tasks/:stageId/report', name: 'StageReport', component: () => import('../views/StageReport.vue'), meta: { title: '阶段填报', parentTitle: '我的待填报', parentPath: '/my-tasks', roles: ['engineer'] } },
