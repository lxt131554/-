...
const projects = [
  { id: 1, name: '古蔺县森林资源调查与空间规划', description: '对古蔺县全域森林资源进行调查评估，编制林地保护利用规划，涉及15人团队、外业调查30天、内业整理25天、成果编制20天。', status: 'active', createUserId: 2, createTime: '2026-05-10 09:30:00',
    ...
    projectImportance: '对甲方：年度森林资源考核重点项目；对我院：拓展县域林草规划业务的关键机会，涉及多专业协同能力提升',
    achievementDirection: '规划文本送省林业局备案、图件提交县自然资源局入库、调查报告作为林地保护利用规划修编依据'
  },
...
const reports = {
  1: [
    { id: 1, stageId: 1, projectId: 1, content: '已完成古蔺县南部片区（观文镇、椒园镇）外业调查，面积约15万亩，设置样地320个，树种以马尾松、杉木、柏木为主，蓄积量约85万立方米。', progressRate: 65, problem: '北部片区地形复杂，部分区域交通不便，预计将延迟5天。需要协调当地林业站配合。', qualityControl: '每样地设置8个检尺点，外业数据当日复核，照片与样地编号一一对应', resultSummary: '完成小班调查表120份、树种分布图2幅、蓄积量统计表1套', coordinationNote: '与县林业局对接3次，院内部协调会2次', deptReviewNote: '部门审核发现图件缺少比例尺标注，已退回修改', actualStart: '2026-05-16', actualEnd: null, reviewStatus: 'pending', reviewComment: null, submitUserId: 3, submitUserName: '李工', submitTime: '2026-05-28 16:30:00', reviewUserId: null, reviewTime: null, createTime: '2026-05-28 16:30:00', attachmentName: '古蔺南部调查报告_初稿.pdf', stageName: '外业调查', projectName: '古蔺县森林资源调查与空间规划' }
  ]
}
