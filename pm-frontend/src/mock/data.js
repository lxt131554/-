...
const stages = {
  1: [
    { id: 1, projectId: 1, stageName: '外业调查', description: '实地勘测数据采集样地调查', planStart: '2026-05-15', planEnd: '2026-06-15', actualStart: '2026-05-16', actualEnd: null, status: 'submitted', assigneeId: 3, assigneeName: '李工', sortOrder: 0, latestReport: { id: 1, content: '已完成南部片区调查约15万亩设样地320个树种马尾松杉木柏木', progressRate: 65, problem: '北部片区地形复杂交通不便预计延迟5天', reviewStatus: 'pending' } },
    { id: 2, projectId: 1, stageName: '内业整理', description: '数据整理图纸绘制统计分析', planStart: '2026-06-16', planEnd: '2026-07-10', actualStart: null, actualEnd: null, status: 'pending', assigneeId: 3, assigneeName: '李工', sortOrder: 1, latestReport: null },
    { id: 3, projectId: 1, stageName: '成果提交', description: '编制报告制作图件提交审核', planStart: '2026-07-11', planEnd: '2026-07-31', actualStart: null, actualEnd: null, status: 'pending', assigneeId: 3, assigneeName: '李工', sortOrder: 2, latestReport: null }
  ],
  2: [
    ...
    { id: 5, projectId: 2, stageName: '系统开发', description: '前后端开发数据库联调测试', planStart: '2026-03-16', planEnd: '2026-04-20', actualStart: '2026-03-18', actualEnd: '2026-04-25', status: 'completed', assigneeId: 3, assigneeName: '李工', sortOrder: 1, latestReport: { id: 5, content: '完成V0.1至V0.6版本开发含30多后端文件15前端页面', progressRate: 100, problem: 'Mock与后端URL不一致已修复', reviewStatus: 'passed' } },
  ...
  4: [
    { id: 10, projectId: 4, stageName: '外业调查', description: '草原退化现状调查鼠荒地治理评估', planStart: '2026-06-01', planEnd: '2026-07-01', actualStart: '2026-06-03', actualEnd: null, status: 'in_progress', assigneeId: 3, assigneeName: '李工', sortOrder: 0, latestReport: { id: 10, content: '完成红原县若尔盖县草原调查布设样方200个采集土壤80份', progressRate: 55, problem: '高寒地区天气多变进度受降雨影响', reviewStatus: 'pending' } },
    { id: 11, projectId: 4, stageName: '方案编制', description: '退化草原生态修复实施方案编制', planStart: '2026-07-02', planEnd: '2026-07-25', actualStart: null, actualEnd: null, status: 'pending', assigneeId: 3, assigneeName: '李工', sortOrder: 1, latestReport: null }
  ],
  5: [
  ...
  6: [
    { id: 14, projectId: 6, stageName: '外业作业', description: '实地测量标志点埋设航拍数据采集', planStart: '2026-04-01', planEnd: '2026-04-30', actualStart: '2026-04-03', actualEnd: '2026-05-05', status: 'completed', assigneeId: 3, assigneeName: '李工', sortOrder: 0, latestReport: { id: 14, content: '完成全部外业作业航拍面积50km2标志点埋设120个', progressRate: 100, problem: '4月中旬连续降雨延误5天', reviewStatus: 'passed' } },
    { id: 15, projectId: 6, stageName: '内业处理', description: '影像处理数据解算成果编制', planStart: '2026-05-06', planEnd: '2026-05-31', actualStart: '2026-05-08', actualEnd: null, status: 'in_progress', assigneeId: 3, assigneeName: '李工', sortOrder: 1, latestReport: { id: 15, content: '完成影像拼接和正射校正正在进行数据解算', progressRate: 60, problem: '部分航拍区域影像拼接存在色差', reviewStatus: 'pending' } }
  ],
  7: [
...
const reports = {
  ...
  10: [{ id: 10, stageId: 10, projectId: 4, content: '完成红原县若尔盖县草原调查布设样方200个采集土壤样本80份', progressRate: 55, problem: '高寒地区天气多变调查进度受降雨影响', qualityControl: '样方GPS定位精度小于5m', resultSummary: '样方调查表200份土壤样本80份', coordinationNote: '与县草原站协调2次', actualStart: '2026-06-03', actualEnd: null, reviewStatus: 'pending', reviewComment: null, submitUserId: 3, submitUserName: '李工', submitTime: '2026-06-20 15:00:00', reviewUserId: null, reviewTime: null, createTime: '2026-06-20 15:00:00', attachmentName: null, stageName: '外业调查', projectName: '阿坝州草原生态修复实施方案' }],
...
const deviations = [
  { id: 1, projectId: 1, stageId: 1, reportId: 1, type: 'auto', description: '北部片区地形复杂延迟5天', reason: '地形复杂部分区域交通不便', impact: '工期延后5天', status: 'open', createUserId: 2, createUserName: '张主任', createTime: '2026-05-28 17:00:00', closeTime: null, projectName: '古蔺县森林资源调查与空间规划', stageName: '外业调查' },
  { id: 2, projectId: 3, stageId: 8, reportId: 8, type: 'auto', description: '林下经济数据不足导致编制延迟3天', reason: '项目对接人变更部分数据缺失', impact: '编制时间顺延3天', status: 'open', createUserId: 2, createUserName: '张主任', createTime: '2026-06-28 09:00:00', closeTime: null, projectName: '攀枝花市林业产业发展规划', stageName: '规划编制' },
  { id: 3, projectId: 6, stageId: 14, reportId: 14, type: 'auto', description: '连续降雨导致外业延期5天', reason: '4月中旬连续降雨无法作业', impact: '整体工期延后5天', status: 'open', createUserId: 2, createUserName: '张主任', createTime: '2026-05-05 16:00:00', closeTime: null, projectName: '洪雅县航拍测绘及数据解算', stageName: '外业作业' },
  { id: 4, projectId: 8, stageId: 19, reportId: 19, type: 'auto', description: '西部片区进度偏慢', reason: '地形复杂调查难度大', impact: '整体进度或将延迟3-5天', status: 'open', createUserId: 2, createUserName: '张主任', createTime: '2026-06-10 14:00:00', closeTime: null, projectName: '绵竹市外业调查与数据分析', stageName: '正式调查' }
]

const supportItems = [
  { id: 1, projectId: 1, title: '需要院领导协调当地林业局配合外业调查', content: '古蔺县北部片区外业调查需要当地林业局提供林地权属资料和配合现场踏勘。目前与地方林业站沟通不畅，对方以资料涉密为由拖延提供，需要院级层面发函协调。', applicantId: 3, applicantName: '李工', handlerId: 2, handlerName: '张主任', expectTime: '2026-06-05', status: 'pending', reply: null, resolveNote: null, createTime: '2026-05-28 17:30:00', updateTime: '2026-05-28 17:30:00', projectName: '古蔺县森林资源调查与空间规划' },
  { id: 2, projectId: 3, title: '草原生态修复方案需要外部专家评审', content: '阿坝州草原生态修复项目涉及高寒草甸恢复技术，院内缺乏该领域专家，需要邀请川农大草原研究所专家参与方案评审。', applicantId: 3, applicantName: '李工', handlerId: 2, handlerName: '张主任', expectTime: '2026-06-15', status: 'pending', reply: null, resolveNote: null, createTime: '2026-05-26 14:00:00', updateTime: '2026-05-26 14:00:00', projectName: '阿坝州草原生态修复项目实施方案' }
]
